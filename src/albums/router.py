...
async def create_album(album: SAlbumAdd = Depends(get_album_create_schema)):
...
async def get_albums(
    ...
    album_schemas = [
        SAlbum.model_validate(album_model, from_attributes=True)
...
async def update_album(
    album_id: int, album: SAlbumAdd = Depends(get_album_create_schema)
):
